...
- 2j) WCA 代理人は特定の種目において競技者を失格させることができる。
    - 2j1) 競技者が何らかの理由で失格となると、その種目における試技を続ける資格はなくなる。
        - 2j1a) その競技者があるラウンドで失格になるまでに、既にそのラウンドで失格となる前に一回以上の試技を行っていた場合、その種目の残りの試技の結果は全て DNF と記録される。その競技者が試技を始めていない場合（すなわち記録がない場合または DNS の記録しかない場合）、失格となったラウンドに関する結果は一切記録されない。
