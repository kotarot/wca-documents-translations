...
- 2i+++) [注意] Bluetooth パズルは電子的な機器と見なされる。
- 2i1b+) [明示] 適切に電源が切られているもしくは接続が切れているような機器も使用不可である。
- 2i1c+) [明示] 電子的なハンドウォーマーは試技の前後にのみ使用することができる。非電子的なハンドウォーマーは試技中にも使用することができる。
- 2i2a+) [追記] カメラの画面は、今映している映像が表示されていない時に限り、競技者から見える向きにすることができる。
- 2j2+) [例] 例えば、競技者が決勝を欠席したことにより出場資格を失っても、その競技者のそれより前のラウンドでの結果は無効にならない。
- 2k6+) [明示] WCA 代理人の裁量は、競技者が試技に重大な不利益を与える（例：時間や大会の人員・資源を浪費する）ことを防ぐためだけに使われるのが望ましい。競技者は持てる能力の限りを尽くして試技をしているならば、「悲惨な」結果によって失格とされるべきではない。
...
- 3j++) [明示] クロックでは、ピンは同じ側の別のピンと区別することができてもよい。
...
- 11e++) [推奨] WCA 代理人は追加試技を行う理由を記録する必要がある（例：記録用紙の裏に記録）。
...
- A2d1+++) [注意] WCA 代理人はスクランブラサインの欠落がある複数の試技を認めることはできるが、スクランブラサインの欠落がよく起こることのないように注意することが望ましい。
